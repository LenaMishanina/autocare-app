...
class HistoryAdapterTest {
    ...
    private val testServices = listOf(
        ServiceEventResponse(1, "Замена масла", "2023-01-15", 10000.0, 1),
        ServiceEventResponse(1, "Замена тормозных колодок", "2023-03-20", 20000.0, 2),
        ServiceEventResponse(1, "Замена воздушного фильтра", "2023-02-10", 15000.0, 3),
        ServiceEventResponse(1, "ЗАМЕНА ТОРМОЗНЫХ КОЛОДОК", "2023-04-01", 22000.0, 4),
        ServiceEventResponse(1, "замена воздушного фильтра", "2023-05-10", 18000.0, 5),
        ServiceEventResponse(1, "Замена масла", "2023-06-05", 25000.0, 6)
    )
