...
class HistoryAdapterTest {
    ...
    fun sortWorksCorrectly() {
        ...
        assertEquals("2025-05-15", adapter.filteredServices[0].due_date)
        assertEquals("2025-05-25", adapter.filteredServices[1].due_date)


        // Test DATE_DESC sort
        adapter.sort(HistoryAdapter.SortType.DATE_DESC)
        assertEquals("2025-05-25", adapter.filteredServices[0].due_date)
        assertEquals("2025-05-15", adapter.filteredServices[1].due_date)
